...
import 'place_tracker_demo.dart';

class MapConfiguration {
  final List<PlaceBean> places;
...
class _PlaceMapState extends State<PlaceMap> {
  ...
  final Map<Marker, PlaceBean> _markedPlaces = <Marker, PlaceBean>{};
  ...
  Future<void> _confirmAddPlace(BuildContext context) async {
    if (_pendingMarker != null) {
      ...
      var placeMarker = await _getPlaceMarkerIcon(context, appState.selectedCategory);
      ...
      final newPlaces = List<PlaceBean>.from(appState.places)..add(newPlace);
  ...
  Future<Marker> _createPlaceMarker(BuildContext context, PlaceBean place) async {
    final marker = Marker(
  ...
  void _onPlaceChanged(PlaceBean value) {
    // Replace the place with the modified version.
    final newPlaces =
    List<PlaceBean>.from(Provider.of<AppState>(context, listen: false).places);
  ...
  void _pushPlaceDetailsScreen(PlaceBean place) {
    Navigator.push<void>(
      context,
  ...
  void _updateExistingPlaceMarker({required PlaceBean place}) {
  ...
  Future<void> _zoomToFitPlaces(List<PlaceBean> places) async {
  ...
  static List<PlaceBean> _getPlacesForCategory(
      PlaceCategory category, List<PlaceBean> places) {
